...
with center_col:
    ...
    st.markdown("<p style='text-align: center;'><b>Contact:</b> <a href='mailto:emirt.worku99@email.com'>emirt.worku99@email.com</a></p>", unsafe_allow_html=True)
...
with col2:
    ...
    input_data['SmokerStatus'] = st.selectbox("Are you a current smoker?", ['Yes', 'No'])
